...
int l9_182=l9_181;
bool l9_183=(*sc_set2.UserUniforms).sc_ProjectionMatrixArray[l9_182][2].w!=0.0;
if ((sc_DepthBufferMode_tmp==1)&&l9_183)
{
float l9_184=2.0/log2((*sc_set2.UserUniforms).sc_Camera.clipPlanes.y+1.0);
l9_180.z=((log2(fast::max((*sc_set2.UserUniforms).sc_Camera.clipPlanes.x,1.0+l9_180.w))*l9_184)-1.0)*l9_180.w;
}
float4 l9_185=l9_180;
l9_169=l9_185;
float4 l9_186=l9_169;
...
{
float l9_189=dot(l9_188,(*sc_set2.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_190=l9_189;
...
{
out.varClipDistance=l9_190;
}
}
float4 l9_191=float4(l9_187.x,-l9_187.y,(l9_187.z*0.5)+(l9_187.w*0.5),l9_187.w);
out.gl_Position=l9_191;
v=param_17;
