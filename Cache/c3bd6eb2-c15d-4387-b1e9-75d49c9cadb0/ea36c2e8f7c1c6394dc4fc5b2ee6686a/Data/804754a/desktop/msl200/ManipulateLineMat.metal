...
int l9_378=l9_377;
bool l9_379=(*sc_set2.UserUniforms).sc_ProjectionMatrixArray[l9_378][2].w!=0.0;
if ((sc_DepthBufferMode_tmp==1)&&l9_379)
{
float l9_380=2.0/log2((*sc_set2.UserUniforms).sc_Camera.clipPlanes.y+1.0);
l9_376.z=((log2(fast::max((*sc_set2.UserUniforms).sc_Camera.clipPlanes.x,1.0+l9_376.w))*l9_380)-1.0)*l9_376.w;
}
float4 l9_381=l9_376;
l9_365=l9_381;
float4 l9_382=l9_365;
...
{
float l9_385=dot(l9_384,(*sc_set2.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_386=l9_385;
...
{
out.varClipDistance=l9_386;
}
}
float4 l9_387=float4(l9_383.x,-l9_383.y,(l9_383.z*0.5)+(l9_383.w*0.5),l9_383.w);
out.gl_Position=l9_387;
v=param_6;
